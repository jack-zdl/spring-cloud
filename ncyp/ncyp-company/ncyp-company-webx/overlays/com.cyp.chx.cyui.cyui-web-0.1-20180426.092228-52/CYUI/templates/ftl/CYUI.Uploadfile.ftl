...
<#macro uploadfile id="" style="" class="" title="" disabled="" readonly="" name="" width="" height="" accept="" tabIndex=""
  value="" iconPos="" iconCls="" type="" check="" dataUrl="" addUrl="" downloadUrl="" fileTypeExts="" fileSizeLimit="" queueSizeLimit=""  uploadSuccess="" uploadError="" showfileList="" autoUpload="">
