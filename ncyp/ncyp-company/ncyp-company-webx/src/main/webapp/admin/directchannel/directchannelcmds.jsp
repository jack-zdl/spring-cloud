...
<div class="main_context">
    <div class="main_inner">
        <div class="block_title_wrap">
            <span class="block_title">直联渠道指令</span>
        </div>
        ...
        <div class="grid_wrap">
            <r:grid id="grid" dataUrl="${pageContext.request.contextPath}/directchannelcmds/page.do"
                    ...
                    "
                    colNames="'ID','代码','代码名称','指令类型','直联渠道','直联支付方式','是否有效'" multiSelect="true"></r:grid>
