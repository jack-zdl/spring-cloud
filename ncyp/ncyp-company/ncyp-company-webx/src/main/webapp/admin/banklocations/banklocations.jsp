...
<div class="main_context">
    <div class="main_inner">
        <div class="block_title_wrap">
            <span class="block_title">开户银行</span>
        </div>
        <div class="grid_wrap">
            <r:grid id="grid" dataUrl="${pageContext.request.contextPath}/banklocation/page.do"
                    ...
                    {name : 'cnapstype',index : 'cnapstype',sortable:false}"
                    colNames="'ID','代码','名称','区域','银行','是否有效','联行号类型'" multiSelect="true"></r:grid>
