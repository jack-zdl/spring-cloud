            ...
            <form id="accountform" class="main_form">
                ...
                <r:tinyPanel title="账户信息" iconCls="none" column="2" hasHeader="false">
                    ...
                    <r:panelItem>
		           	...
		           	<r:panelItem>
                        <jsp:include page="/common/wedget/combogrid.jsp">
                            <jsp:param name="id" value="associatedaccountid"/>
                            <jsp:param name="valueField" value="urid"/>
                            <jsp:param name="displayField" value="bankaccountnumber"/>
                            <jsp:param name="title" value="关联支付宝账户"/>
                            <jsp:param name="dataUrl" value="${pageContext.request.contextPath}/account/page.do?accounttype=3&orgid=${orgid}"/>
                            <jsp:param name="check" value="required"/>
                        </jsp:include>
                    </r:panelItem>
                    <r:panelItem>
