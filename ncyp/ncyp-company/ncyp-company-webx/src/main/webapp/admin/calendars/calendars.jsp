...
<div class="main_context">
    <div class="main_inner">
        <div class="block_title_wrap">
            <span class="block_title">日历</span>
        </div>
        <r:buttonList>
        ...
        <div class="grid_wrap">
            <r:grid id="grid" dataUrl="${pageContext.request.contextPath}/calendars/page.do"
                    colModel="{name : 'urid',index : 'urid',sortable:false,hidden:true},
                    {name : 'name',index : 'name',sortable:false},
                    {name : 'isactive',index : 'isactive',sortable:false},
                    {name : 'monday',index : 'monday',sortable:false},
                    {name : 'tuesday',index : 'tuesday',sortable:false},
                    {name : 'wednesday',index : 'wednesday',sortable:false},
                    {name : 'thursday',index : 'thursday',sortable:false},
                    {name : 'friday',index : 'friday',sortable:false},
                    {name : 'saturday',index : 'saturday',sortable:false},
                    {name : 'sunday',index : 'sunday',sortable:false},
                    {name : 'description',index : 'description',sortable:false}"
                    colNames="'ID','名称','是否有效',
                    '星期一是否工作日','星期二是否工作日',
                    '星期三是否工作日','星期四是否工作日',
                    '星期五是否工作日','星期六是否工作日',
                    '星期天是否工作日','描述'" multiSelect="true"></r:grid>
