...
<%
    ...
    String dataUrl = request.getContextPath() + "/purchasetdaccountmanage/tradebalances/add.do";
    if(modFlag){
        dataUrl = request.getContextPath() + "/purchasetdaccountmanage/tradebalances/edit.do";
    }
%>
    ...
    $(function(){
        if(<%=modFlag%>){
            Ajax.req({
                ...
                method: "get",
                params: {
                    uc: "UC_SCS_TA_PURCHASETRADEBALANCES_SEARCH",
                    urid: "<%=urid%>"
                },
                ok: function(text){
