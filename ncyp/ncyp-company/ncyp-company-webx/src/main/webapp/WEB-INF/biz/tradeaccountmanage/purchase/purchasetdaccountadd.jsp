...
<%
    ...
    String dataUrl = request.getContextPath() + "/purchasetdaccountmanage/tradeaccount/add.do";
    if(modFlag){
        dataUrl = request.getContextPath() + "/purchasetdaccountmanage/tradeaccount/edit.do";
    }
%>
    ...
    $(function(){
        if(<%=modFlag%>){
            Ajax.req({
                 ...
                 method: "get",
                 params: {
                     uc: "UC_SCS_TA_PURCHASETRADEACCOUNT_SEARCH",
                     urid: "<%=urid%>"
                 },
                 ok: function(text){
