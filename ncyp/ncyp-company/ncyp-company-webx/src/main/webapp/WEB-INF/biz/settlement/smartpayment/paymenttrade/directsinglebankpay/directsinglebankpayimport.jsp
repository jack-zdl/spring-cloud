...
<%
    ...
    String url = request.getContextPath() + "/uploadtomemory?withouttranslate=true&type=directsinglebankpay&userid=" + userid +
...
<script type="text/javascript">
	...
	var paytypeidBFn = function(){
		return [{
	        ...
	        'moneyway': '1',
	        'paytypecategory': '0',
	        'directpaywaynotin': '2,4'//直联渠道指令的直联支付方式不包含批量代收和批量代付
		}];
    }
    //选择交易类型,设置结算方式
