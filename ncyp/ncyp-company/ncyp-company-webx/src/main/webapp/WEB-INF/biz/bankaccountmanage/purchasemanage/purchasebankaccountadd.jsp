...
<%
    ...
    String dataUrl = request.getContextPath() + "/purchasebkaccountmanage/bankaccount/add.do";
    if(modFlag){
        dataUrl = request.getContextPath() + "/purchasebkaccountmanage/bankaccount/edit.do";
    }
%>
...
<script type="text/javascript">
    $(function(){
        if(<%=modFlag%>){
            Ajax.req({
                url: "${pageContext.request.contextPath}/login/query.do",
                type: "json",
                method: "get",
                params: {
    ...
    $(function(){
        $("#isbankdirect").change(function(){
            if($("#isbankdirect").prop("checked")){
                $("#isbillvirtual").attr("checked", false);
                $("#iscashvirtual").attr("checked", false);
            }
        });

        $("#isbillvirtual").change(function(){
            if($("#isbillvirtual").prop("checked")){
                $("#isbankdirect").attr("checked", false);
                $("#iscashvirtual").attr("checked", false);
            }
        });
