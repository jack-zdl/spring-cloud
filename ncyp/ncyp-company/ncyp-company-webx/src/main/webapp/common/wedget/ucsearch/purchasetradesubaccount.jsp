...
%>
<r:comboGrid
        valueField="urid"  displayField="subaccountname"    multiSelect="${param.multiSelect}"
        filterField="subaccountname"
        ...
        colModel="[{title:'账号',field:'subaccountname',width:120}]"
        width="${param.width}"
        check="${param.check}"
        disabled="${param.disabled}"
        selectable="${param.selectable}"
        readonly="${param.readonly}"
        dataUrl="${pageContext.request.contextPath}/common/query.do?uc=UC_SCS_TA_PURCHASETRADESUBACCOUNT_SEARCH"
        />
