...
<r:combo check="<%=check%>" id="<%=id%>" name="<%=id%>" autoload="true" defaultValue="${param.defaultValue}"
         ...
         displayFormat="{displayField}" title="${param.title}" width="${param.width}" afterSelect="${param.afterSelect}"
         dataUrl="${pageContext.request.contextPath}/common/queryDicOption.do?keyno=9999052"/>