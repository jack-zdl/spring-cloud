...
%>
<r:comboGrid
        valueField="urid"  displayField="fieldname"    multiSelect="${param.multiSelect}"
        ...
        colModel="[{title:'名称',field:'fieldname',width:120}]"
        width="${param.width}"
        check="${param.check}"
        disabled="${param.disabled}"
        selectable="${param.selectable}"
        readonly="${param.readonly}"
        dataUrl="${pageContext.request.contextPath}/common/query.do?uc=UC_BASE_WARNINGOBJECT_ATTRIBUTE_SEARCH&isactive=1"
        />
