...
<%
    ...
    String dataUrl = request.getContextPath() + "/activeservice/groupmanage/add.do";;
    if(modFlag){
        dataUrl = request.getContextPath() + "/activeservice/groupmanage/edit.do";
    }
%>
<jsp:include page="/common/formhead.jsp"/>
    <form role="form" id="groupmanageadd">
...
<script type="text/javascript">
    $(function(){
        if(<%=modFlag%>){
            Ajax.req({
                ...
                ok: function(text){
                    $("#groupmanageadd").RForm({value:text});
                },
                err: function(text){
    ...
    var saveFn = function(){
        $("#groupmanageadd").RValidate({
            'success': function(){
                var params = $("#groupmanageadd").AllSerialize();
                Ajax.req({
                    url: '<%=dataUrl%>',
                    params: params,
                    ok: function(text) {
        ...
        $("#groupmanageadd").RValidate("validate");
    }
