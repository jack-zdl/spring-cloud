...
<r:button text="新增" iclass="fa-plus" visible="<%=userid+\"#rule/extobjects/add\"%>" onClick="addFn" />
<r:button text="修改" iclass="fa-pencil-square-o" visible="<%=userid+\"#rule/extobjects/edit\"%>" onClick="editFn" />
<r:button text="删除" iclass="fa-remove" visible="<%=userid+\"#rule/extobjects/del\"%>" onClick="delFn" />
...
<script type="text/javascript">
    ...
    var addFn = function(){
        var url = "${pageContext.request.contextPath}/base/rule/extobjectconf/extobjectsadd.jsp?type=add";
    ...
    var editFn = function(){
        ...
        var url = "${pageContext.request.contextPath}/base/rule/extobjectconf/extobjectsadd.jsp?type=mod&urid=" + rowData[0].urid;
    ...
    var delFn = function(){
        ...
        $.RMessage.confirm("消息", "是否确认删除！", function(){
            Ajax.req({
                url: "${pageContext.request.contextPath}/rule/extobjects/del.do",
                params: {
                    ids: pksArray.join(",")
                },
                ok: function(text) {
