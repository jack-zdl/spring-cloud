...
<%@ page import="com.ceying.chx.controller.system.SysMenuController" %>
<%@ page import="com.ceying.chx.dto.system.SysMenu" %>
...
//    SysUserDto  currUser = (SysUserDto)request.getSession().getAttribute(UserConstant.USER_SESSION);
    ...
    List<SysMenu> firstLevelMenus = CommonQueryController.queryMenu(parentCode);
    int  firstMenus_size=0;
    if (firstLevelMenus!=null){
        firstMenus_size = firstLevelMenus.size();
    }
        ...
        <div class="menu_list">
            <ul class="page_nav" id="page_nav">
                <li class="active dianji" id="index" index="1" create="true">
                    <div style="width: 32px;"><img src="../image/img/workbench(w).png" alt="工作�?"></div>
...
<script>
    ...
    window.onload = function () {
        Ajax.req({
            method: "POST",
            url: '${pageContext.request.contextPath}/sysmenu/page.do',
            params:{
                parentCode:'BIZFRAME'
            },
            async: false,
