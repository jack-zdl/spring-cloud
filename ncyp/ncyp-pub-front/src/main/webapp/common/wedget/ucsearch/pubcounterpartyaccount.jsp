...
%>
<r:comboGrid
        valueField="urid"  displayField="accountnumber"    multiSelect="${param.multiSelect}"
        ...
        colModel="[{title:'银行账号',field:'accountnumber',width:120}]"
        width="${param.width}"
        ...
        dataUrl="${pageContext.request.contextPath}/common/query.do?uc=UC_SCS_SE_COUNTERPARTYACCOUNT_SEARCH"
        />
