...
%>
<r:comboGrid
        valueField="urid"  displayField="bankaccountnumber"    multiSelect="${param.multiSelect}"
        filterField="bankaccountnumber"
        ...
        colModel="[{title:'银行账号',field:'bankaccountnumber',width:120}]"
        width="${param.width}"
        check="${param.check}"
        disabled="${param.disabled}"
        selectable="${param.selectable}"
        readonly="${param.readonly}"
        dataUrl="${pageContext.request.contextPath}/common/query.do?uc=UC_SCS_BA_PURCHASEBANKACCOUNT_SEARCH"
        />
