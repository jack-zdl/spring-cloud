...
<%
    ...
    String dataUrl = request.getContextPath()+"/common/query.do?uc=UC_SYS_USER_SEARCH"+linkageParam;
%>
<r:comboGrid
        valueField="user_id"  displayField="user_name"    multiSelect="${param.multiSelect}"
        ...
        colModel="[{title:'用户名称',field:'user_name',width:120}]"
        width="${param.width}"
