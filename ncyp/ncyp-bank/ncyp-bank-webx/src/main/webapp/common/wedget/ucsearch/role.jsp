...
%>
<r:comboGrid
        valueField="role_code"  displayField="role_name"    multiSelect="${param.multiSelect}"
        ...
        colModel="[{title:'代码-名称',field:'role_name',width:120}]"
        width="${param.width}"
        check="${param.check}"
        disabled="${param.disabled}"
        selectable="${param.selectable}"
        readonly="${param.readonly}"
        dataUrl="${pageContext.request.contextPath}/common/query.do?uc=UC_SYS_ROLE_SEARCH"
        />
