...
%>
<r:comboGrid
        valueField="tenant_id"  displayField="codename"    multiSelect="${param.multiSelect}"
        ...
        dataUrl="${pageContext.request.contextPath}/common/query.do?uc=UC_SYS_SYSCOMPANY_SEARCH"
        />
