...
%>
<r:comboGrid
        valueField="code"  displayField="codename"    multiSelect="${param.multiSelect}"
        ...
        dataUrl="${pageContext.request.contextPath}/common/query.do?uc=UC_BASE_BANK_BANKLOCATIONS_SEARCH"
        />
