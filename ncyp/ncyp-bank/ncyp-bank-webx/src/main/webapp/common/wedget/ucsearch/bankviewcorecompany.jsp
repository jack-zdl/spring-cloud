...
<%@page import="com.ceying.chx.common.constants.ServiceNameConstants" %>
...
//    request.getContextPath()+"/common/query.do?uc=UC_RFP_BANKVIEWCORECOMPANY_SEARCH";
    String dataUrl = TAG+"/Organization/selectList";
%>
<%
