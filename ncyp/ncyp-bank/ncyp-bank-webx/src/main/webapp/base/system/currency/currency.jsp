...
<%
    ...
    String queryuc = "UC_BASE_SET_CURRENCY_SEARCH";
%>
...
<r:button text="新增" iclass="fa-plus" visible="<%=userid+\"#generalset/currency/add\"%>" onClick="addFn" />
<r:button text="修改" iclass="fa-pencil-square-o" visible="<%=userid+\"#generalset/currency/edit\"%>" onClick="editFn" />
<r:button text="删除" iclass="fa-remove" visible="<%=userid+\"#generalset/currency/del\"%>" onClick="delFn" />
...
<script type="text/javascript">
    ...
    var addFn = function(){
        var url = "${pageContext.request.contextPath}/base/system/currency/currencyadd.jsp?type=add";
    ...
    var editFn = function(){
        ...
        var url = "${pageContext.request.contextPath}/base/system/currency/currencyadd.jsp?type=mod&urid=" + rowData[0].urid;
    ...
    var delFn = function(){
        ...
        $.RMessage.confirm("消息","是否确认删除？",function(){
        	Ajax.req({
                url: "${pageContext.request.contextPath}/generalset/currency/del.do",
                params: {
                    ids: pksArray.join(",")
                },
                ok: function(text) {
