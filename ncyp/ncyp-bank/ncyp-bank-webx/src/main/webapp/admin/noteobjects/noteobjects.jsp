...
<div class="main_context">
    <div class="main_inner">
        <div class="block_title_wrap">
            <span class="block_title">单据对象</span>
        </div>
        <r:buttonList>
        ...
        <div class="grid_wrap">
            <r:grid id="grid" dataUrl="${pageContext.request.contextPath}/noteobjects/page.do"
                    ...
                    colNames="'ID','代码','代码名称','是否有效'" multiSelect="true"></r:grid>
