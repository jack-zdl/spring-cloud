...
<%@ page import="com.ceying.chx.controller.CommonController" %>
<%@ page import="com.ceying.chx.common.dto.SysUserLoginDto" %>
<%@ page import="com.ceying.chx.common.constants.UserConstant" %>

<%
    String dataUrl = CommonController.getFrontName()+"/sysrole/page.do";
...
<r:buttonList>
    <r:button text="新增" iconCls="add" visible="<%=userid+\"#usermanage/role/add\"%>" onClick="roleAdd" />
...
<div class="grid_wrap">
    <r:grid id="roleGrid" dataUrl="<%=dataUrl%>"
