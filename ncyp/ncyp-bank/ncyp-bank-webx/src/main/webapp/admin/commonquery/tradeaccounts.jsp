...
<jsp:include page="/common/search.jsp">
    <jsp:param name="rows" value="[
        {id : 'accountcategory',name : 'accountcategory',title:'交易账户类别',type:'combo',url:'${pageContext.request.contextPath}/common/queryDicOption.do?keyno=9999069'},
        {id : 'accountstate',name : 'accountstate',title:'交易账户状态',type:'combo',url:'${pageContext.request.contextPath}/common/queryDicOption.do?keyno=9999070'},
    ...
    <jsp:param name="defaultQuery" value="{id : 'orgid',name : 'orgid',title:'所属组织'}" />
</jsp:include>
...
<r:grid id="orgGrid" dataUrl="${pageContext.request.contextPath}/cpi/tradeaccounts.do"
        colModel="{name : 'accountname',index : 'accountname',sortable:false},
                    {name : 'accountnumber',index : 'accountnumber',sortable:false},
                    {name : 'accountcategory',index : 'accountcategory',sortable:false,hidden:true},
                    {name : 'accountcategoryname',index : 'accountcategoryname',sortable:false},
                    {name : 'accountstate',index : 'accountstate',sortable:false,hidden:true,hidden:true},
                    {name : 'accountstatename',index : 'accountstatename',sortable:false},
                    {name : 'orgid',index : 'orgid',sortable:false,hidden:true},
                    {name : 'orgname',index : 'orgname',sortable:false}"
        colNames="'交易账户','账号','交易账户类别','交易账户类别','交易账户状态','交易账户状态','所属组织','所属组织'" multiSelect="true"></r:grid>
