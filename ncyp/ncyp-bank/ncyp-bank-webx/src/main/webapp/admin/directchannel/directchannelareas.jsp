...
<div class="main_context">
    <div class="main_inner">
        <div class="block_title_wrap">
            <span class="block_title">直联渠道区域</span>
        </div>
        <r:buttonList>
        ...
        <div class="grid_wrap">
            <r:grid id="grid" dataUrl="${pageContext.request.contextPath}/directchannelareas/page.do"
                    ...
                    colNames="'ID','代码','代码名称','区域','直联渠道','是否有效'" multiSelect="true"></r:grid>
