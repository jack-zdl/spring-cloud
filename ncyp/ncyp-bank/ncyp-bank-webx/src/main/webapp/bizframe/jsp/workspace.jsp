...
<div class="task_wrap">
    <div class="task_list">
        ...
        <div class="exit">
            <a id="logout" target="_parent" href="${pageContext.request.contextPath}/user/logout.do"><img src="../image/img/end.png" alt="退出平台"></a>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    window.onload = function () {
        var userid = "<%=userid%>";
        var parentCode = 'workBench';

        Ajax.req({
         url: configObject.TAG+'/workbench/queryUserMenu.do',
         type: "json",
         method: "POST",
         async: false,
         params: {
         ...
         for (var i = 0; i < submenuList.length; i++) {
             appendStr = appendStr + '<li page-href="'+submenuList[i].attribute1+'" class="dianji" ><span><img src="${pageContext.request.contextPath}/bizframe/image/img/to-dos(g).png">'+submenuList[i].menuName+'</span>';
//             appendStr = appendStr + '<li page-href="'+submenuList[i].attribute1+'" class="dianji" ><span><img src="../image/img/to-dos(g).png">'+submenuList[i].menuName+'</span></li>';
             if(submenuList[i].menuCode=="WBflowTaskTodo"&&todoTaskSimple()){
                 appendStr = appendStr + '<div class="new"></div>';
             }
    ...
    function payableIntentionList(queryuc,operationflag,lastoperationflag){
        Ajax.req({
            url: configObject.TAG+'/common/query.do',
            type:"json",
            async:false,
            method:"get",
            params: {
