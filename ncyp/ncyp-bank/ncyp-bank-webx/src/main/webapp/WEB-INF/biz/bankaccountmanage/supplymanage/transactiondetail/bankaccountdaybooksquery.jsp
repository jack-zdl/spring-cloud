...
<%
    ...
    String formUrl = request.getContextPath() + "/supplybkaccountmanage/bankaccountdetail/getflow.do";
%>

<jsp:include page="/common/formhead.jsp"/>
    <form role="form" id="bankaccountdaybooksquery">
...
<script type="text/javascript">
    var saveFn = function(){
        $("#bankaccountdaybooksquery").RValidate({
            'success': function(){
                var params = $("#bankaccountdaybooksquery").AllSerialize();
                $("body").doMask();
                Ajax.req({
                    url: "<%=formUrl%>",
                    params: params,
        ...
        $("#bankaccountdaybooksquery").RValidate("validate");
    }
</script>