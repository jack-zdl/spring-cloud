...
<%
    ...
    String dataUrl = request.getContextPath() + "/supplytdaccountmanage/tradetransactions/add.do";
    if(modFlag){
        dataUrl = request.getContextPath() + "/supplytdaccountmanage/tradetransactions/edit.do";
    }
%>
    ...
    $(function(){
        if(<%=modFlag%>){
            Ajax.req({
                 ...
                 method: "get",
                 params: {
                     uc: "UC_SCS_TA_SUPPLYTRADETRANSACTIONS_SEARCH",
                     urid: "<%=urid%>"
                 },
                 ok: function(text){
