    ...
    $(function(){
        Ajax.req({
            ...
            ok: function(text){
                ...
                $("#tradeaccountid").RComboGrid("setValue");
                $("#tradeaccounttypeid").RComboGrid("setValue");
                $("#tradeaccountid").RComboGrid("setReadOnly", true);
                $("#tradeaccounttypeid").RComboGrid("setReadOnly", true);
            },
            err: function(text){
