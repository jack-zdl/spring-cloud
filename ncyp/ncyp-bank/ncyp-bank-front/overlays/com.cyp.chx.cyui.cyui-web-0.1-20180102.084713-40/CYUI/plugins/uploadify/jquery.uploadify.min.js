...
SWFUpload.prototype.initSWFUpload = function (c) {//0000
    console.log(c);
    try {
        this.customSettings = {};
        this.settings = c;
...
SWFUpload.prototype.startUpload = function (b) {//000
...
(function (c) {
    var b = {
        ...
        init: function (d, e) {
            return this.each(function () {
                ...
                var h = (o.major >= 9);
                if (h) {
                    window["uploadify_" + j.id] = new SWFUpload(g);//00000
    ...
    var a = {
        onDialogOpen: function () {
            var d = this.settings;
            this.queueData.errorMsg = "附件上传失败：";
            ...
            for (var g in this.queueData.files) {
                ...
                if (f.uploaded != true && f.name == h.name) {
                    var e = confirm('"' + h.name + '" 已被选择，请勿重复上传！');
                    if (!e) {
